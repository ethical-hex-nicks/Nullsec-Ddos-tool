...
class CliAttacker:
    ...
    async def get_all_ips(self):
        # fetch lists with bounded concurrency
        ...
        try:
            ...
            async with session.get(self.target_url, headers=headers, timeout=per_request_timeout) as response:
                ...
                if 200 <= response.status < 300:
                    ...
                    self.fail_count += 1
                # periodic logging every 50 successes (you can change this)
    ...
    async def attack(self):
        ...
        # Limit total connections (avoid limit=0 which means "no limit" and can exhaust FD)
